        ...
        <div class="col-md-20 col-md-offset-0">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    @if (Auth::check())
                        @role('admin')
                      <a href="{{url('/matches/create')}}" class="btn btn-primary btn-sm">Add New Match </a>
                        @endrole
                        <div class="pull-right">
                        <a href="{{action('Excelcontroller@exportmatches')}}" class="btn btn-primary btn-sm">Download</a>
                        </div>
                    @endif
                      </div>
    <hr>
