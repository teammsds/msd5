...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=jaldi:100,300,400,700">
    ...
    <!-- <style>
        body { font-family: Arial, Helvetica, sans-serif;font-weight: bold;color: #FFFFFF; }
